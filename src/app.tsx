    ...
    const fetchData = async () => {
        ...
        setForecasts(
            response.data.map((item: StockForecast) => ({
                ...
                pe_current: Number((Number(item.price) / Number(item.eps_ttm)).toFixed(2)),
                ...
                ps_current: Number((Number(item.price) / Number(item.sps_ttm)).toFixed(2)),
                ...
                pb_current: Number((Number(item.price) / Number(item.nav_ttm)).toFixed(2)),
                ...
                pocf_current: Number((Number(item.price) / Number(item.ocf_ttm)).toFixed(2)),

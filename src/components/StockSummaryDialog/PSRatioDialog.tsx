...
export const PSRatioDialog = React.memo<Props>(({open, onClose, symbol, stockSummaries}) => {
                        ...
                        datasets: [
                            ...
                            },
                            {
                                ...
                                data: stockPrices.map(item => {
                                    ...
                                    return Number(stockSummaries[0].ps_high) * Number(summary.sps);
                                }),
                                fill: false,
                            ...
                            },
                            {
                                ...
                                data: stockPrices.map(item => {
                                    ...
                                    return Number(stockSummaries[0].ps_avg) * Number(summary.sps);
                                }),
                                fill: false,
                            ...
                            },
                            {
                                ...
                                data: stockPrices.map(item => {
                                    ...
                                    return Number(stockSummaries[0].ps_low) * Number(summary.sps);
                                }),
                                fill: false,

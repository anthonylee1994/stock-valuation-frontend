...
export const PERatioDialog = React.memo<Props>(({open, onClose, symbol, stockSummaries}) => {
                        ...
                        datasets: [
                            ...
                            },
                            {
                                ...
                                data: stockPrices.map(item => {
                                    ...
                                    return Number(stockSummaries[0].pe_high) * Number(summary.eps);
                                }),
                                fill: false,
                            ...
                            },
                            {
                                ...
                                data: stockPrices.map(item => {
                                    ...
                                    return Number(stockSummaries[0].pe_avg) * Number(summary.eps);
                                }),
                                fill: false,
                            ...
                            },
                            {
                                ...
                                data: stockPrices.map(item => {
                                    ...
                                    return Number(stockSummaries[0].pe_low) * Number(summary.eps);
                                }),
                                fill: false,
